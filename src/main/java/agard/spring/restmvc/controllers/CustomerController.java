...
public class CustomerController {
    ...
    public Customer getCustomerById(@PathVariable(CUSTOMER_ID_PARAM) UUID customerId){
    ...
    public ResponseEntity updateById(@PathVariable(CUSTOMER_ID_PARAM) UUID customerId, @RequestBody Customer customer){
    ...
    public ResponseEntity patchById(@PathVariable(CUSTOMER_ID_PARAM) UUID customerId, @RequestBody Customer customer){
